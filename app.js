...
/**
 * Student: Joshua Oosterman
 * SN: 300302076
 * Assignment: React Assignment
 * Additional Notes: I tried to create a delete button and while it did display, onClick did not have an effect. 
 * 
 * 
 * 
 */
...
//passing down props to each object of each array element 
  );
  }
...
// iterates each element/object for each planet 
    ...
    ReactDOM.render(
      <Component planets={planets} removePlanet={RemovePlanet}/>,
